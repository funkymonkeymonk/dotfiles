...
# <xbar.var>string(GITHUB_TOKEN=''): Your Github.com personal access token]</xbar.var>
# <xbar.var>string(GITHUB_ENTERPRISE_TOKEN=''): Your Github enterprise personal access token]</xbar.var>
# <xbar.var>string(GITHUB_ENTERPRISE_URL='https://github.example.com/api/v3'): Your Github enterprise api url]</xbar.var>
